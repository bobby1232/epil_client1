...
async def ensure_default_services(session: AsyncSession) -> None:
    ...
    if q.first():
        return
    session.add_all([
        Service(name="Шугаринг: верхняя губа", price=100, duration_min=10, buffer_min=0, is_active=True, sort_order=10),
        Service(name="Шугаринг: глубокое бикини", price=1500, duration_min=50, buffer_min=0, is_active=True, sort_order=20),
        Service(name="Шугаринг: голени", price=900, duration_min=50, buffer_min=0, is_active=True, sort_order=30),
        Service(name="Шугаринг: живот", price=100, duration_min=30, buffer_min=0, is_active=True, sort_order=40),
        Service(name="Шугаринг: живот полностью", price=400, duration_min=40, buffer_min=0, is_active=True, sort_order=50),
        Service(name="Шугаринг: классическое бикини", price=700, duration_min=30, buffer_min=0, is_active=True, sort_order=60),
        Service(name="Шугаринг: ноги до колена полностью", price=900, duration_min=40, buffer_min=0, is_active=True, sort_order=70),
        Service(name="Шугаринг: ноги полностью", price=1800, duration_min=50, buffer_min=0, is_active=True, sort_order=80),
        Service(name="Шугаринг: подмышки", price=500, duration_min=10, buffer_min=0, is_active=True, sort_order=90),
        Service(name="Шугаринг: руки выше локтя", price=350, duration_min=20, buffer_min=0, is_active=True, sort_order=100),
        Service(name="Шугаринг: подбородок", price=100, duration_min=10, buffer_min=0, is_active=True, sort_order=110),
        Service(name="Шугаринг: шея", price=400, duration_min=15, buffer_min=0, is_active=True, sort_order=120),
        Service(name="Шугаринг: лицо полностью", price=800, duration_min=20, buffer_min=0, is_active=True, sort_order=130),
        Service(name="Шугаринг: ягодицы", price=400, duration_min=15, buffer_min=0, is_active=True, sort_order=140),
        Service(name="Шугаринг: руки до локтя", price=350, duration_min=30, buffer_min=0, is_active=True, sort_order=150),
        Service(name="Шугаринг: руки полностью", price=700, duration_min=40, buffer_min=0, is_active=True, sort_order=160),
        Service(name="Шугаринг: бёдра", price=900, duration_min=10, buffer_min=0, is_active=True, sort_order=170),
        Service(name="Шугаринг: все тело", price=6000, duration_min=120, buffer_min=0, is_active=True, sort_order=180),
        Service(name="Лазерная эпиляция: глубокое бикини", price=1500, duration_min=35, buffer_min=0, is_active=True, sort_order=190),
        Service(name="Лазерная эпиляция: классическое бикини", price=800, duration_min=35, buffer_min=0, is_active=True, sort_order=200),
        Service(name="Лазерная эпиляция: голени", price=1000, duration_min=35, buffer_min=0, is_active=True, sort_order=210),
        Service(name="Лазерная эпиляция: ягодицы", price=1000, duration_min=35, buffer_min=0, is_active=True, sort_order=220),
        Service(name="Лазерная эпиляция: ноги полностью", price=2000, duration_min=35, buffer_min=0, is_active=True, sort_order=230),
        Service(name="Лазерная эпиляция: глубокое бикини + голени + подмышки", price=3500, duration_min=35, buffer_min=0, is_active=True, sort_order=240),
        Service(name="Лазерная эпиляция: руки до локтя", price=800, duration_min=35, buffer_min=0, is_active=True, sort_order=250),
        Service(name="Лазерная эпиляция: подмышки", price=600, duration_min=30, buffer_min=0, is_active=True, sort_order=260),
        Service(name="Лазерная эпиляция: руки полностью", price=1500, duration_min=35, buffer_min=0, is_active=True, sort_order=270),
        Service(name="Лазерная эпиляция: тело полностью", price=5000, duration_min=120, buffer_min=0, is_active=True, sort_order=280),
        Service(name="Лазерная эпиляция: лицо полностью", price=1000, duration_min=20, buffer_min=0, is_active=True, sort_order=290),
        Service(name="Лазерная эпиляция: шея", price=600, duration_min=15, buffer_min=0, is_active=True, sort_order=300),
        Service(name="Лазерная эпиляция: ягодицы", price=600, duration_min=15, buffer_min=0, is_active=True, sort_order=310),
    ])
